...
from second_choice_content_logic import (
...
class SecondChoiceUpdater:
    ...
    def update_second_choice(room_number: str, building_id: str,
        ...
        Args:
            room_number: 部屋番号
            building_id: 物件ID
            date1: 第一希望日 (YYYY-MM-DD)
            time1: 第一希望時間帯 (例: "09:00～12:00")
            date2: 第二希望日 (YYYY-MM-DD)
        ...
        try:
            ...
            # 2.5 waku_pattern_id 自動解決
            if waku_pattern_id is None:
            ...
            second_choice_text = build_second_choice_string(
                date1, time1, date2, time2, date3, time3, waku_pattern_id
            )
...
def update_second_choice(room_number: str, building_id: str,
                        ...
                        date2: str, time2: str,
                        date3: str = "", time3: str = "",
                        waku_pattern_id: Optional[int] = None, connection=None) -> dict:
...
if __name__ == "__main__":
    ...
    # 現在の第二希望を取得
    current_result = get_current_second_choice("103", "3760")
    ...
    # 第二希望をクリア
    clear_result = clear_second_choice("103", "3760")
