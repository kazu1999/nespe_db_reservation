...
#### 2.1 update_second_choice() メイン処理
...
#### 2.2 get_current_second_choice() 現在の第二希望取得
...
#### 2.3 clear_second_choice() 第二希望クリア
...
#### 2.4 get_second_choice_history() 第二希望履歴取得
...
#### 3.1 get_reservation_date() 予約日程取得
